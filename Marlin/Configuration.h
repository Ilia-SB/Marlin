...
#define STRING_CONFIG_H_AUTHOR "(Ilia_SB, default config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 101.09 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 0.32   // Z offset: -below +above  [the nozzle]
